...
async function main() {
    ...
    const empPasswordHash = await bcryptjs_1.default.hash('Employee@123', 12);
    ...
    // ─────────────────────────────────────────────
    const assetData = [
        { tag: 'AF-0001', name: 'Dell Laptop 15"', categoryId: electronics.id, serialNumber: 'SN-DELL-001', condition: 'GOOD', location: 'IT Room - Shelf A', isBookable: false, departmentId: itDept.id, acquisitionCost: 65000 },
        { tag: 'AF-0002', name: 'HP Laptop Pro', categoryId: electronics.id, serialNumber: 'SN-HP-002', condition: 'EXCELLENT', location: 'IT Room - Shelf A', isBookable: false, departmentId: itDept.id, acquisitionCost: 72000 },
        { tag: 'AF-0003', name: 'Conference Room B2', categoryId: rooms.id, serialNumber: null, condition: 'EXCELLENT', location: 'Floor 2 - Block B', isBookable: true, acquisitionCost: null },
        { tag: 'AF-0004', name: 'Conference Room A1', categoryId: rooms.id, serialNumber: null, condition: 'GOOD', location: 'Floor 1 - Block A', isBookable: true, acquisitionCost: null },
        { tag: 'AF-0005', name: 'Toyota Innova MH-01-AB-1234', categoryId: vehicles.id, serialNumber: 'VIN-TOY-1234', condition: 'GOOD', location: 'Parking B2', isBookable: true, acquisitionCost: 1500000 },
        { tag: 'AF-0006', name: 'Office Chair Executive', categoryId: furniture.id, serialNumber: 'CH-EXEC-006', condition: 'GOOD', location: 'IT Room', isBookable: false, departmentId: itDept.id, acquisitionCost: 8500 },
        { tag: 'AF-0007', name: 'Projector BenQ MH535', categoryId: electronics.id, serialNumber: 'SN-BENQ-007', condition: 'GOOD', location: 'Conference Room B2', isBookable: true, acquisitionCost: 35000 },
        { tag: 'AF-0008', name: 'Server Dell PowerEdge', categoryId: equipment.id, serialNumber: 'SN-SVR-008', condition: 'EXCELLENT', location: 'Server Room', isBookable: false, departmentId: itDept.id, acquisitionCost: 350000 },
    ];
